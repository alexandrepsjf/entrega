...
import model.ConcreteBuilderCombo2;
 ...
 * @author negro
 */
public class CriarCombo2Action implements Action {

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        MontadorComboDirector montador=new MontadorComboDirector(new ConcreteBuilderCombo2());
